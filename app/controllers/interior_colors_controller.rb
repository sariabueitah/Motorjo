class InteriorColorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @interior_color.save
        format.html { redirect_to interior_colors_path, notice: 'Interior color was successfully created.' }
  ...
  private
    ...
    def interior_color_params
      params.require(:interior_color).permit(:title,InteriorColor.globalize_attribute_names)
    end
end
