...
class DealersControllerTest < ActionController::TestCase
  ...
  test "should create dealer" do
    assert_difference('Dealer.count') do
      post :create, dealer: { building_number: @dealer.building_number, gallery_location: @dealer.gallery_location, gallery_name: @dealer.gallery_name, street_name: @dealer.street_name }
    end
  ...
  test "should update dealer" do
    patch :update, id: @dealer, dealer: { building_number: @dealer.building_number, gallery_location: @dealer.gallery_location, gallery_name: @dealer.gallery_name, street_name: @dealer.street_name }
    assert_redirected_to dealer_path(assigns(:dealer))
  end
